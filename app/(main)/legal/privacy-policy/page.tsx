  ...
  return (
    <div className="container mx-auto px-4 my-10">
      <div className="flex flex-col gap-4">
        ...
        <Typography variant="p" text="Updated at 2025-03-11" />
        ...
        <Typography variant="h2" text="What Information Do We Collect?" />
        <Typography
          variant="p"
        ...
        <Typography variant="h2" text="How Do We Use The Information We Collect?" />
        <Typography
          variant="p"
        ...
        <Typography variant="p" text="We use various tracking technologies:" />
        <ul className="list-disc pl-6 space-y-2">
          <li>
          ...
          <li>
            ...
            <Typography
              variant="p"
              text="We use 'Sessions' to identify the areas of our website that you have visited. A Session is a small piece of data stored on your computer or mobile device by your web browser."
            />
          </li>
        </ul>

        <Typography variant="h2" text="Kids' Privacy" />
        <Typography
          variant="p"
        ...
        <Typography variant="h2" text="Changes To Our Privacy Policy" />
        <Typography
          variant="p"
        ...
        <Typography variant="h2" text="Contact Us" />
